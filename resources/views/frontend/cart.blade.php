          ...
          <table class="cart-table">
            ...
            <tbody>
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="assets/frontend/images/cart-item-1.jpg" width="120" height="120" alt="" />
                  </div>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="assets/frontend/images/cart-item-2.jpg" width="120" height="120" alt="" />
                  </div>
                </td>
                <td>
                  <div class="shopping-cart__product-item__detail">
              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="assets/frontend/images/cart-item-3.jpg" width="120" height="120" alt="" />
                  </div>
                </td>
                <td>
                  <div class="shopping-cart__product-item__detail">
