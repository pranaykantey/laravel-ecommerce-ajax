      ...
      <div class="row">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset($product->image)}}" width="674"
                      height="674" alt="" />
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset($product->image)}}" width="104" height="104" alt="" /></div>
                  {{-- <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            ...
            @else
            <small class="current-price"><del>${{$product->regular_price}}</del> </small>
            <span class="current-price ml-2">${{$product->sale_price}}</span>
            @endif
          </div>
